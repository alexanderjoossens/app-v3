...
function getTracks(user, code) {
    ...
    let tracksToReturn = []
    if (user == 'a') {
        sqlTra = "SELECT tracksA FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
    else {
        sqlTra = "SELECT tracksB FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
...
function getArtists(user, code) {
    ...
    let sqlArt = ""
    if (user == 'a') {
        sqlArt = "SELECT artistsA FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
    else {
        sqlArt = "SELECT artistsB FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
...
function getRecTrackTitles(user, code) {
    let sql3 = ""
    if (user == 'a') {
        sql3 = "SELECT recTracksA FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
    else {
        sql3 = "SELECT recTracksB FROM vectors2 WHERE code = '"+code.toString()+"'";
    }
    let regex = /\\/g;
    let recoSongTitles = []
